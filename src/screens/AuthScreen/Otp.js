...
import { StyleSheet, Text, View, KeyboardAvoidingView, Platform , TouchableOpacity,ImageBackground} from 'react-native'
...
const Otp = ({navigation}) => {
   ...
   const dispatch = useDispatch()
    ...
    return (
        ...
        <View>
            <ImageBackground source={sms} style={{width:100,height:100}}/>
        </View>
        </>
    )
}
